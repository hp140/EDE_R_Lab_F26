...
NTL.phys.data.Tuesday9099 <- 
  filter(NTL.phys.data, 
...
> Answer: It would take a lot of manual searching--if you know what range you're searching for, it would be faster setting up the function
...
NTL.phys.data.processed2 <- 
  filter(NTL.phys.data, lakename == "Tuesday Lake", year4 %in% c(1990:1999), month(sampledate) == 07)
